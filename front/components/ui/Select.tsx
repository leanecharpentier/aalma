...
const trigger = tv({
	base: "flex flex-row items-center gap-2 cursor-pointer transition-colors outline-none text-sm",
	variants: {
		variant: {
			default:
				"px-3 py-2 rounded-xl border border-gray-100 bg-white text-gray-600 hover:bg-gray-50",
			filter:
				"p-3 rounded-lg border border-gray-100 bg-gray-50 text-gray-700 hover:bg-gray-100",
		},
	},
	defaultVariants: {
		variant: "default",
...
export default function Select({
	...
	return (
		...
		>
			...
			<Button className={trigger({ variant })}>
				{icon}
