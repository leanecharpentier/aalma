export function Stats() {
  return (
    <section className="w-full px-6 lg:px-12 py-16 bg-primary-50">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-center gap-12 lg:gap-24">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div>
            <p className="text-sm font-bold text-foreground">Cout national</p>
